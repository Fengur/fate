...
@interface FGCarouselItem : NSObject
 ...
 *  Online Image
 */
@interface FGCarouselURLItem : FGCarouselItem
 ...
 *  Custom View
 */
@interface FGCarouselViewItem : FGCarouselItem
...
typedef void (^FGCarouselViewDidSelectBlock)(FGCarouselItem *item, NSInteger index);
typedef void (^FGCarouselViewDidChangeBlock)(FGCarouselView *view, NSInteger index);
